...
VkDescriptorSet DescriptorAllocator::Allocate(const VkDevice &device, const std::span<VkDescriptorSetLayout> &layout) {
...
VkDescriptorPool DescriptorAllocator::CreatePool(const VkDevice &device, const uint32_t maxSets, const std::span<PoolSizeRatio> &poolRatios) {
